...
public class BasicDocument extends Document 
{
	...
	public int getNumWords()
	{
		...
		//System.out.println(" getNumWords count = "+tokens.size());
	    return tokens.size();
	}
	...
	public int getNumSentences()
	{
		...
		//System.out.println("@@$#$ getNumSentences count ="+tokens.size());
	    return tokens.size();        
	}
	...
	public int getNumSyllables()
	{
		...
		//System.out.println(" @@#$ get syllables count ="+numSyllables);
		return numSyllables ;
	}
